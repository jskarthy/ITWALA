...
namespace BusinessLogic.BusinessModel
{
    public class MyMembershipProvider : MembershipProvider
    {
        ...
        public bool ValidateUserExists(string username, string email)
        {
            var user = _myDatabaseEntities.Users.Where(u => u.Username == username || u.Email == email).FirstOrDefault();
            if (user != null)
            {
                return true;
            }
